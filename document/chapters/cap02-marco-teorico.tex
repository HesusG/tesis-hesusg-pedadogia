...
\section{La Herencia Educativa Confuciana}
...
Este modelo es directamente relevante para el análisis de políticas: predice que los sistemas de herencia confuciana formularán sus políticas de IA con mayor centralización estatal, mayor articulación entre educación y proyecto nacional de desarrollo, y mayor énfasis en la formación de talento como vía meritocrática~\citep{marginson2011higher, knox2020artificial}. El XV Plan Quinquenal chino, que subordina la política educativa a una planificación nacional integral mediante la iniciativa AI+~\citep{china2026fyp}, constituye la expresión contemporánea más acabada de ese estilo. La pregunta empírica de esta tesis es si tales rasgos dejan huellas semánticas observables que distingan a los países CHC del Sudeste Asiático de sus vecinos.
