...
La inteligencia artificial (IA) se integra en los sistemas educativos del mundo a un ritmo que supera la capacidad de respuesta de las instituciones encargadas de regularla. Según el AI Index 2024, el 55\% de las organizaciones reportaban haber adoptado IA en al menos una función de negocio, un aumento respecto al 20\% registrado en 2017, y la inversión corporativa global en el sector alcanzó los 189.2 mil millones de dólares en 2023~\citep{maslej2024aiindex}. Esta adopción ha comenzado a modificar las expectativas sobre qué competencias necesitan los estudiantes y cómo deben preparar las instituciones educativas a sus egresados.

Las políticas educativas, sin embargo, avanzan más lentamente. \citet{thierer2018pacing} describió este fenómeno como el \textit{pacing problem}: la tecnología evoluciona de forma exponencial mientras que la regulación progresa de manera lineal, lo que genera una brecha que se amplía con el tiempo. En el caso de la IA en educación, esta brecha es aguda. Según la UNESCO, hacia principios de 2023 unos 67 países habían desarrollado o planeaban estrategias nacionales de IA, pero la educación figuraba en ellas principalmente en términos de desarrollo de talento para la competitividad nacional, más que como un tema de política educativa en sí~\citep{unesco2023genai}.

La brecha se manifiesta en múltiples frentes. En materia curricular, según datos de la UNESCO, solo unos 15 países habían desarrollado o estaban desarrollando currículos de IA para educación básica avalados por sus gobiernos hacia 2022~\citep{unesco2023genai}. En formación docente, solo siete países reportaban haber desarrollado marcos o programas de capacitación en IA para profesores~\citep{unesco2023genai}. En gobernanza, apenas el 16\% de los países garantizaban explícitamente la privacidad de datos en educación mediante legislación~\citep{unesco2023gem}. \citet{miao2021guidance} identificaron cinco brechas concretas en la preparación institucional: ausencia de marcos regulatorios, insuficiencia en la formación docente, falta de estándares curriculares, inequidades en infraestructura digital y carencia de directrices éticas para el uso de IA en escuelas.

Los procesos de formulación e implementación de políticas educativas suelen extenderse a lo largo de varios años. El cómputo dedicado al entrenamiento de modelos de IA, en contraste, se ha duplicado aproximadamente cada seis meses desde el inicio de la era del aprendizaje profundo en 2010~\citep{sevilla2022compute}. El desfase tiende a ser estructural: para cuando una política educativa sobre IA alcanza las aulas, la tecnología que pretendía regular suele haber sido superada. Este fenómeno reproduce lo que David Collingridge denominó el dilema del control: cuando una tecnología es nueva, sus impactos son difíciles de predecir; cuando sus impactos son claros, la tecnología ya está arraigada~\citep{thierer2018pacing}.

La respuesta de los países ha sido desigual. Un primer grupo actuó con rapidez. China publicó su Plan de Desarrollo de IA de Nueva Generación en 2017, uno de los primeros documentos nacionales en vincular explícitamente la IA con la reforma educativa. Posteriormente implementó corrección automática de ensayos mediante IA en 60,000 escuelas~\citep{pedro2019aieducation}. Corea del Sur anunció su Estrategia Nacional de Inteligencia Artificial en 2019 con un componente educativo~\citep{korea2019ai}. Finlandia lanzó el curso masivo \textit{Elements of AI} en 2018, con el objetivo de que el 1\% de su población adquiriera conocimientos básicos sobre IA~\citep{pedro2019aieducation, tuomi2018impact}. Singapur publicó su Estrategia Nacional de IA en 2019 e integró la alfabetización en datos e IA en sus programas educativos~\citep{singapore2019nais}. Estonia, con menos de 1.4 millones de habitantes, incorporó la programación y el pensamiento computacional desde educación primaria y se convirtió en referencia europea de digitalización educativa~\citep{oecd2021digitaloutlook}.
...
El caso de México ilustra los desafíos que enfrentan los países que aún no han formalizado una estrategia de IA. Pese a ser miembro de la OCDE y signatario tanto del Consenso de Beijing~\citep{unesco2019beijing} como de los Principios de IA de la OCDE~\citep{oecd2019ai}, México no había adoptado formalmente una estrategia nacional de IA al momento de esta investigación~\citep{cminds2018iamexico}. Ni el Programa Sectorial de Educación 2020--2024~\citep{sep2020sectorial} ni la Nueva Escuela Mexicana~\citep{sep2022nem} integran la inteligencia artificial como contenido curricular ni como herramienta pedagógica. La sección~\ref{sec:justificacion} examina esta brecha con mayor detalle.

La literatura académica refleja vacíos paralelos. \citet{zawacki2019systematic} revisaron 146 estudios sobre IA en educación superior publicados entre 2007 y 2018: el 62\% fueron realizados por investigadores de departamentos de ciencias de la computación y STEM, mientras que solo el 8.9\% provino de departamentos de educación. Prácticamente ninguno realizó comparaciones sistemáticas entre países sobre políticas de IA en educación. \citet{miao2021guidance} identificaron que el desarrollo de políticas específicas para IA en educación permanecía rezagado respecto a la investigación técnica. Esta ausencia persiste. La investigación se concentra en aplicaciones pedagógicas (tutores inteligentes, analítica del aprendizaje) y rara vez examina los marcos de política pública que determinan cómo y bajo qué condiciones se implementa la IA en los sistemas educativos.
...
Esta investigación contribuye al campo en dos vertientes. Ofrece un análisis comparativo del estado actual de las políticas de educación en IA, un tema que carece de estudios exhaustivos que abarquen múltiples regiones. Además, explora la viabilidad de integrar herramientas de procesamiento de lenguaje natural (PLN) en la investigación educativa comparada, un área metodológica que ha recibido poca atención. La combinación de lectura cualitativa con análisis semántico computacional permite detectar patrones a una escala que ninguno de los dos métodos podría alcanzar por sí solo, y esta complementariedad distingue el enfoque adoptado en la investigación.

\subsection{Justificación política}

México ocupa el lugar 68 en el Índice de Preparación Gubernamental para la IA de Oxford Insights, con un puntaje de 50.37, y el sexto lugar en América Latina, detrás de Brasil, Chile, Uruguay, Colombia y Argentina~\citep{oxfordinsights2023}. Entre estos países, México era el que presentaba menor avance en la formalización de una estrategia nacional de IA al momento de esta investigación. El proceso iniciado en 2018 con el documento \textit{Hacia una Estrategia de IA en México}~\citep{cminds2018iamexico} no alcanzó a formalizarse como política de Estado antes de la transición de gobierno de ese año, y el tema no tuvo continuidad institucional inmediata.

En el ámbito educativo, el rezago es mayor. El Programa Sectorial de Educación 2020--2024~\citep{sep2020sectorial} aborda las tecnologías de la información y la comunicación en términos generales pero omite la inteligencia artificial como prioridad curricular. La Nueva Escuela Mexicana~\citep{sep2022nem} organiza los contenidos en campos formativos con un enfoque comunitario y humanístico, sin abordar la IA como objeto de estudio ni como herramienta pedagógica. Chile, por su parte, publicó su Política Nacional de Inteligencia Artificial en 2021 con un capítulo dedicado a educación~\citep{chile2021ia}. Colombia emitió el CONPES 3975 en 2019 con componentes educativos explícitos~\citep{colombia2019conpes}. Brasil incluyó la educación como uno de los nueve ejes estratégicos de su EBIA~\citep{brasil2021ebia}.

Las condiciones de infraestructura representan un desafío adicional. Según la ENDUTIH 2023, el 81.2\% de la población mexicana de seis años o más usaba internet, pero la conectividad se distribuye de manera desigual: en zonas urbanas la penetración alcanzaba el 85.5\%, mientras que en zonas rurales se ubicaba en 66.0\%~\citep{inegi2024endutih}. El equipamiento tecnológico de las escuelas públicas depende en buena medida de programas federales cuya continuidad ha variado entre administraciones. Esta disparidad en el acceso digital constituye un factor que cualquier política de IA en educación tendría que considerar.

La formación docente en tecnologías digitales también presenta áreas de oportunidad. El sistema de educación básica cuenta con más de un millón de profesores, y los programas de actualización profesional han incorporado contenidos digitales de manera gradual, aunque la IA, el aprendizaje automático y el análisis de datos educativos aún no figuran de manera prominente en la oferta formativa~\citep{oecd2021digitaloutlook}.

La continuidad de las políticas públicas entre administraciones representa un factor relevante en el contexto mexicano. Como se describió en la sección~\ref{sec:problematica}, el proceso IA2030MX no alcanzó a formalizarse antes de la transición de 2018, y la agenda educativa se reorientó hacia la Nueva Escuela Mexicana. Los ciclos de gobierno de seis años plantean desafíos de continuidad que otras investigaciones sobre política educativa en México han documentado~\citep{pedro2019aieducation}.

Esta investigación busca aportar al debate sobre política educativa en México un análisis de las prácticas internacionales y su posible transferibilidad al contexto local. Un análisis comparativo riguroso puede contribuir a informar la formulación de políticas con evidencia de las experiencias de otros países y las lecciones que de ellas se derivan.

\subsection{Justificación metodológica}

El uso de \textit{embeddings} de texto y bases de datos vectoriales para analizar documentos de política educativa representa un aporte metodológico al campo. El PLN se ha consolidado como herramienta de investigación en ciencia política~\citep{grimmer2013text, rodriguez2022embeddings}, pero su aplicación en educación comparada es incipiente. Los modelos de \textit{topic modeling} como LDA y STM~\citep{roberts2019stm} se han aplicado a textos legislativos y políticos, pero rara vez a documentos de política educativa. El uso de \textit{embeddings} semánticos para medir la similitud entre políticas de diferentes países ha sido poco explorado en la literatura revisada.

La diferencia entre los \textit{topic models} tradicionales y los \textit{embeddings} semánticos es sustancial. Los modelos como LDA tratan los documentos como bolsas de palabras y pierden información sobre el orden y el contexto. Los \textit{embeddings} generados por modelos de lenguaje entrenados sobre grandes corpus capturan relaciones semánticas más sutiles~\citep{rodriguez2022embeddings}. En una comparación de políticas educativas escritas en múltiples idiomas, esta capacidad resulta particularmente valiosa: dos documentos pueden abordar el mismo tema con vocabularios diferentes. Uno puede hablar de ``competencias digitales'' y otro de ``habilidades computacionales'', y los \textit{embeddings} detectan la proximidad semántica que un análisis por palabras clave pasaría por alto.
