...
La literatura académica refleja vacíos paralelos. \citet{zawacki2019systematic} revisaron 146 estudios sobre IA en educación superior publicados entre 2007 y 2018: más del 70\% fueron realizados por científicos de la computación, no por educadores, y prácticamente ninguno realizó comparaciones sistemáticas entre países sobre políticas de IA en educación. \citet{miao2021guidance} identificaron que el desarrollo de políticas específicas para IA en educación permanecía rezagado respecto a la investigación técnica. Esta ausencia persiste. La investigación se concentra en aplicaciones pedagógicas (tutores inteligentes, analítica del aprendizaje) y rara vez examina los marcos de política pública que determinan cómo y bajo qué condiciones se implementa la IA en los sistemas educativos.
...
México ocupa el lugar 55 en el Índice de Preparación Gubernamental para la IA de Oxford Insights y el cuarto lugar en América Latina, detrás de Chile, Brasil y Colombia~\citep{oxfordinsights2023}. Entre estos cuatro países, México era el que presentaba menor avance en la formalización de una estrategia nacional de IA al momento de esta investigación. El proceso iniciado en 2018 con el documento \textit{Hacia una Estrategia de IA en México}~\citep{cminds2018iamexico} no alcanzó a formalizarse como política de Estado antes de la transición de gobierno de ese año, y el tema no tuvo continuidad institucional inmediata.
